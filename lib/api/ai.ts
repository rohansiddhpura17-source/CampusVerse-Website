...
export const aiApi = {
  async askStudyAssistant(
    ...
    return apiClient.post('/ai/study-assistant', { query, mode, topic });
  },
  ...
  async askCareerAssistant(
    ...
    return apiClient.post('/ai/career-assistant', { query, mode, topic });
  },
  ...
  async getAspirantRecommendations(
    ...
    return apiClient.post('/ai/aspirant-recommendations', { query, mode, topic });
  },
};
